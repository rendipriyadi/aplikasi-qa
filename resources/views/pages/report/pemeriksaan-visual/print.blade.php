...
<head>
    ...
    <title>Laporan pemeriksaan visual - QA</title>
</head>
        ...
        <tbody>
            ...
            <tr>
                <td align="center" colspan="6" class="brd"
                    ...
                    {{ strtoupper($inspection_material->material_submission->jenis_pekerjaan) }}</td>
            </tr>
            <tr style="font-size: 13px">
                <td style="border-right: 0; font-weight: bold;">Hari/Tgl Pemeriksaan</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">
                    {{ Carbon\Carbon::parse($inspection_material->tgl_pemeriksaan)->translatedFormat('l, d F Y') }}
                </td>
                <td style="border-right: 0; font-weight: bold;">Nomor Kontrak</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">{{ $inspection_material->material_submission->no_kontrak }}</td>
            </tr>
            <tr style="font-size: 12px">
                <td style="border-right: 0; font-weight: bold;">Lokasi / Work Shop</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">{{ $inspection_material->lokasi }}</td>
                <td style="border-right: 0; font-weight: bold;">Kontraktor Pelaksana</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">{{ $inspection_material->material_submission->vendor->name }}</td>
            </tr>
            <tr>
                <table border="1" width="100%">
                    <tr style="border-top: 0; font-weight: bold;">
                        <td align="center">A</td>
                        <td align="left" colspan="5">PEMERIKSAAN MATERIAL</td>
                    </tr>
                    <tr style="font-weight: bold;">
                        ...
                        <td align="center" colspan="2" style="width: 30%">Pemeriksaan Visual</td>
                    </tr>
                    @foreach ($check_material as $check_material_item)
                        <tr>
                            <td align="left">
                                {{ $loop->iteration }}.
                                {{ $check_material_item->jenis }}
                            </td>
                            <td align="center">{{ $check_material_item->sumber }}</td>
                            <td align="center">
                                {{ $check_material_item->jumlah }}
                                {{ $check_material_item->satuan->name }}
                            </td>
                            <td align="left" colspan="2">
                                @if ($check_material_item->metode == 'Pemeriksaan Visual')
                                    &#128505
                                @else
                                    <input type="checkbox" style="width:10px;">
                                @endif
                                <label>{{ $check_material_item->metode }}</label>
                            </td>
                        </tr>
                    @endforeach
                    <tr>
                    ...
                    <tr>
                        <td style="border-bottom: 0;">Hasil Pemeriksaan *</td>
                ...
                <table border="1" width="100%">
                    <tr style="border-top: 0; font-weight: bold;">
                        ...
                        <td align="left" colspan="7">PEMERIKSAAN ALAT</td>
                    </tr>
                    <tr>
                        <td rowspan="10"></td>
                    ...
                    @foreach ($check_tool as $check_tool_item)
                        <tr>
                            <td style="height: 20px">
                                {{ $loop->iteration }}.
                                {{ $check_tool_item->jenis }}
                            </td>
                            <td style="height: 20px">{{ $check_tool_item->type }}</td>
                            <td style="height: 20px">{{ $check_tool_item->kapasitas }}</td>
                            <td style="height: 20px" align="center">{{ $check_tool_item->tahun }}</td>
                            ...
                            <td style="height: 20px" align="center">
                                ...
                                {{ isset($check_tool_item->satuan_id) ? $check_tool_item->satuan->name : '' }}
                            </td>
                            <td style="height: 20px">
                ...
                <table border="1" width="100%" style="border-top: 0;">
                    ...
                    <tr>
                        ...
                        <td colspan="5"
                            ...
                            {!! $inspection_material->keterangan !!}
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="center" style="border-left: 0; border-right: 0; height: 20px;">
                            {{ $inspection_material->created_by }}
                        </td>
                        <td style="border-left: 0; border-bottom: 0;"></td>
                    </tr>
                </table>
                <table border="0" width="100%" style="border-top: 0; margin-top: 20px;">
                    <tr>
                        ...
                        <td style="width: 120px;">- Hasil Pemeriksaan</td>
                        <td>:</td>
                        <td>
