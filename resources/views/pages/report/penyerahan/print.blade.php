...
<head>
    ...
    <title>Laporan pembuatan sampel/pendaftaran lab - QA</title>
</head>
...
<body onload="window.print();">
    <table border="1" width="100%">
        <thead>
            ...
            <tr>
                <th align="right" colspan="5" class="brd" style="font-size: 12px;">FR-TEK-02/01-002</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                <td align="center" colspan="6" class="brd"
                    ...
                    {{ strtoupper($transfer_material->material_submission->jenis_pekerjaan) }}</td>
            </tr>
            <tr style="font-size: 13px">
                <td style="border-right: 0; font-weight: bold;">Hari/Tgl Pembuatan/Pendaftaran</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">
                    {{ Carbon\Carbon::parse($transfer_material->tgl_penyerahan)->translatedFormat('l, d F Y') }}
                </td>
                <td style="border-right: 0; font-weight: bold;">Nomor Kontrak</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">{{ $transfer_material->material_submission->no_kontrak }}</td>
            </tr>
            <tr style="font-size: 12px">
                <td style="border-right: 0; font-weight: bold;">Lokasi / Work Shop</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">{{ $transfer_material->lokasi }}</td>
                <td style="border-right: 0; font-weight: bold;">Kontraktor Pelaksana</td>
                <td style="border-left: 0; border-right: 0;">:</td>
                <td style="border-left: 0;">{{ $transfer_material->material_submission->vendor->name }}</td>
            </tr>
            <tr>
                <table border="1" width="100%">
                    <tr style="border-top: 0; font-weight: bold;">
                        <td align="center">A</td>
                        <td align="left" colspan="5">PEMBUATAN/PENDAFTARAN MATERIAL</td>
                    </tr>
                    <tr style="font-weight: bold;">
                        ...
                        <td align="center" colspan="2" style="width: 30%">Pembuatan Sampel / Pendaftaran Lab</td>
                    </tr>
                    @foreach ($trans_material as $trans_material_item)
                        <tr>
                            <td align="left">
                                {{ $loop->iteration }}.
                                {{ $trans_material_item->check_material->jenis }}
                            </td>
                            <td align="center">{{ $trans_material_item->check_material->sumber }}</td>
                            <td align="center">
                    ...
                    <tr>
                        <td style="border-bottom: 0;">Hasil Pembuatan/Pendaftaran*</td>
                ...
                <table border="1" width="100%">
                    <tr style="border-top: 0; font-weight: bold;">
                        ...
                        <td align="left" colspan="7">PEMBUATAN/PENDAFTARAN ALAT</td>
                    </tr>
                    <tr>
                        <td rowspan="10"></td>
                        ...
                        <td align="center">Hasil Pemeriksaan</td>
                    </tr>
                    @foreach ($trans_tool as $trans_tool_item)
                        <tr>
                            <td style="height: 20px;">
                                {{ $loop->iteration }}.
                                {{ $trans_tool_item->jenis }}
                            </td>
                            <td style="height: 20px">{{ $trans_tool_item->type }}</td>
                            <td style="height: 20px">{{ $trans_tool_item->kapasitas }}</td>
                            <td style="height: 20px" align="center">{{ $trans_tool_item->tahun }}</td>
                            ...
                            <td style="height: 20px" align="center">
                                ...
                                {{ isset($trans_tool_item->satuan_id) ? $trans_tool_item->satuan->name : '' }}
                            </td>
                            <td style="height: 20px">
                ...
                <table border="0" width="100%" style="border-top: 0; margin-top: 20px;">
                    <tr>
                        ...
                        <td style="width: 200px;">- Hasil Pembuatan/Pendaftaran</td>
                        <td>:</td>
                        <td>
