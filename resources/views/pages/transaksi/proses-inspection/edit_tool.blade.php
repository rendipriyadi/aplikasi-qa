        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Check Tool</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('backsite.dashboard.index') }}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Check Tool</a></li>
                                <li class="breadcrumb-item active">Edit</li>
                                <li class="breadcrumb-item"><a
                                        href="{{ route('backsite.inspection_material.proses', encrypt($check_tool->inspection_material_id)) }}">kembali</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.check_tool.update', [$check_tool->id]) }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="jenis" name="jenis"
                                                            class="form-control"
                                                            value="{{ old('jenis', isset($check_tool) ? $check_tool->jenis : '') }}"
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="type" name="type"
                                                            class="form-control"
                                                            value="{{ old('type', isset($check_tool) ? $check_tool->type : '') }}"
                                                            autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="kapasitas" name="kapasitas"
                                                            class="form-control"
                                                            value="{{ old('kapasitas', isset($check_tool) ? $check_tool->kapasitas : '') }}"
                                                            autocomplete="off">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="tahun"
                                                            ...
                                                            value="{{ isset($check_tool) ? $check_tool->tahun : '' }}"
                                                            autocomplete="off">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="jumlah" name="jumlah"
                                                            class="form-control"
                                                            value="{{ old('jumlah', isset($check_tool) ? $check_tool->jumlah : '') }}"
                                                            autocomplete="off" required>
                                                        ...
                                                        <select name="satuan_id" id="satuan"
                                                            ...
                                                            @foreach ($satuan as $key => $satuan_item)
                                                                <option value="{{ $satuan_item->id }}"
                                                                    {{ $satuan_item->id == $check_tool->satuan_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="kondisi" id="kondisi"
                                                            ...
                                                            <option value="1"
                                                                {{ $check_tool->konidisi == 1 ? 'selected' : '' }}>Baik
                                                            </option>
                                                            <option value="2"
                                                                {{ $check_tool->konidisi == 2 ? 'selected' : '' }}>Sedang
                                                            </option>
                                                            <option value="3"
                                                                {{ $check_tool->konidisi == 3 ? 'selected' : '' }}>Rusak
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="hasil" id="hasil"
                                                            class="form-control select2" required>
                                                            <option value="1"
                                                                {{ $check_tool->hasil == 1 ? 'selected' : '' }}>Sesuai
                                                            </option>
                                                            <option value="2"
                                                                {{ $check_tool->hasil == 2 ? 'selected' : '' }}>Tidak
                                                                Sesuai</option>
                                                        </select>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.inspection_material.proses', encrypt($check_tool->inspection_material_id)) }}"
