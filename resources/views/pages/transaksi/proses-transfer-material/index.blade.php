                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('backsite.material_submission.penyerahan', encrypt($transfer_material->material_submission_id)) }}">kembali</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <a data-action="collapse">
                                            <h4 class="card-title text-white">Pembuatan Sampel/Pendaftaran Lab Material</h4>
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form" action="{{ route('backsite.trans_material.store') }}"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <input type="hidden" id="transfer_material_id"
                                                        name="transfer_material_id" class="form-control"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="metode" id="metode"
                                                                ...
                                                                <option value="1">Pembuatan benda uji</option>
                                                                <option value="2">Pendaftaran lab</option>
                                                            </select>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Pembuatan Sampel/Pendaftaran Lab Material List</h4>
                                        <a class="heading-elements-toggle"><i
                                                class="la la-ellipsis-v font-medium-3"></i></a>
                                        <div class="heading-elements">
                                            <ul class="list-inline mb-0">
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        @forelse($trans_material as $key => $trans_material_item)
                                                            <tr>
                                                                <td class="text-center">{{ $loop->iteration }}</td>
                                                                <td>{{ $trans_material_item->check_material->jenis ?? '' }}
                                                                </td>
                                                                <td>{{ $trans_material_item->check_material->sumber ?? '' }}
                                                                </td>
                                                                <td>
                                                                    {{ $trans_material_item->jumlah ?? '' }}
                                                                    {{ $trans_material_item->satuan->name ?? '' }}
                                                                </td>
                                                                <td>
                                                                    @if ($trans_material_item->metode == 1)
                                                                        <span
                                                                            class="badge badge-success">{{ 'Pembuatan benda uji' }}</span>
                                                                    @elseif($trans_material_item->metode == 2)
                                                                        <span
                                                                            class="badge badge-danger">{{ 'Pendaftaran lab' }}</span>
                                                                    @else
                                                                        <span>{{ 'N/A' }}</span>
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if ($trans_material_item->hasil == 1)
                                                                        <span
                                                                            class="badge badge-success">{{ 'Sesuai' }}</span>
                                                                    @elseif($trans_material_item->hasil == 2)
                                                                        <span
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a href="#mymodal"
                                                                                data-remote="{{ route('backsite.trans_material.show', encrypt($trans_material_item->id)) }}"
                                                                                data-toggle="modal" data-target="#mymodal"
                                                                                data-title="Pembuatan Sampel/Pendaftaran Lab Material Detail"
                                                                                class="dropdown-item">
                                                                                Show
                                                                            </a>
                                                                            @if (Auth::user()->detail_user->type_user_id == 1 || Auth::user()->detail_user->type_user_id == 3)
                                                                                <a class="dropdown-item"
                                                                                    href="{{ route('backsite.trans_material.edit', encrypt($trans_material_item->id)) }}">
                                                                                    Edit
                                                                                </a>
                                                                                <form
                                                                                    action="{{ route('backsite.trans_material.destroy', encrypt($trans_material_item->id)) }}"
                                                                                    method="POST"
                        ...
                        <div class="col-12">
                            ...
                            @if (Auth::user()->detail_user->type_user_id == 1 || Auth::user()->detail_user->type_user_id == 3)
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <a data-action="collapse">
                                            <h4 class="card-title text-white">Pembuatan Sampel/Pendaftaran Lab Alat</h4>
                                            <a class="heading-elements-toggle"><i
                                                    class="la la-ellipsis-v font-medium-3"></i></a>
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form" action="{{ route('backsite.trans_tool.store') }}"
                                                method="POST" enctype="multipart/form-data">
                    ...
                    <section id="table-home">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Pembuatan sampel/PendaftaranAlat List</h4>
                                        <a class="heading-elements-toggle"><i
                                                class="la la-ellipsis-v font-medium-3"></i></a>
                                        <div class="heading-elements">
                                            <ul class="list-inline mb-0">
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        @forelse($trans_tool as $key => $trans_tool_item)
                                                            <tr>
                                                                <td class="text-center">{{ $loop->iteration }}</td>
                                                                <td>{{ $trans_tool_item->jenis ?? '' }}
                                                                </td>
                                                                <td>{{ $trans_tool_item->type ?? '' }}
                                                                </td>
                                                                <td>
                                                                    {{ $trans_tool_item->jumlah ?? '' }}
                                                                    {{ $trans_tool_item->satuan->name ?? '' }}
                                                                </td>
                                                                <td>{{ $trans_tool_item->tahun ?? '' }}
                                                                </td>
                                                                <td>
                                                                    @if ($trans_tool_item->kondisi == 1)
                                                                        <span
                                                                            class="badge badge-yellow">{{ 'Baik' }}</span>
                                                                    @elseif($trans_tool_item->kondisi == 2)
                                                                        <span
                                                                            class="badge badge-success">{{ 'Sedang' }}</span>
                                                                    @elseif($trans_tool_item->kondisi == 3)
                                                                        <span
                                                                ...
                                                                <td>
                                                                    @if ($trans_tool_item->hasil == 1)
                                                                        <span
                                                                            class="badge badge-yellow">{{ 'Sesuai' }}</span>
                                                                    @elseif($trans_tool_item->hasil == 2)
                                                                        <span
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a href="#mymodal"
                                                                                data-remote="{{ route('backsite.trans_tool.show', encrypt($trans_tool_item->id)) }}"
                                                                                data-toggle="modal" data-target="#mymodal"
                                                                                data-title="Pembuatan Sampel/Pendaftaran Lab Alat Detail"
                                                                                class="dropdown-item">
                                                                                Show
                                                                            </a>
                                                                            @if (Auth::user()->detail_user->type_user_id == 1 || Auth::user()->detail_user->type_user_id == 3)
                                                                                <a class="dropdown-item"
                                                                                    href="{{ route('backsite.trans_tool.edit', encrypt($trans_tool_item->id)) }}">
                                                                                    Edit
                                                                                </a>
                                                                                <form
                                                                                    action="{{ route('backsite.trans_tool.destroy', encrypt($trans_tool_item->id)) }}"
                                                                                    method="POST"
                                                                                    onsubmit="return confirm('Anda yakin ingin menghapus data ini ?');">
                                                                                    <input type="hidden" name="_method"
                                                                                        value="DELETE">
