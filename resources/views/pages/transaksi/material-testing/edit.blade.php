        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Pengujian</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('backsite.dashboard.index') }}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Pengujian</a></li>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.material_testing.update', [$material_testing->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-md-2 label-control" for="tgl_pengujian">Tgl Pengujian
                                                        <code style="color:red;">required</code></label>
                                                    <div class="col-md-4">
                                                        <input type="text" id="tgl_pengujian" name="tgl_pengujian"
                                                            class="form-control"
                                                            value="{{ old('tgl_pengujian', isset($material_testing) ? $material_testing->tgl_pengujian : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="lokasi" name="lokasi"
                                                            class="form-control"
                                                            value="{{ old('lokasi', isset($material_testing) ? $material_testing->lokasi : '') }}"
                                                            autocomplete="off">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="status" id="status"
                                                            ...
                                                            <option value="1"
                                                                {{ $material_testing->status == 1 ? 'selected' : '' }}>
                                                                Sesuai</option>
                                                            <option value="2"
                                                                {{ $material_testing->status == 2 ? 'selected' : '' }}>
                                                                Tidak Sesuai</option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea rows="5" class="form-control summernote" id="keterangan" name="keterangan">{{ isset($material_testing) ? $material_testing->keterangan : '' }}</textarea>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.material_submission.pengujian', encrypt($material_testing->material_submission_id)) }}"
