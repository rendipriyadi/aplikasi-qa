...
{{-- set title --}}
@section('title', 'Edit - Test Material')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Test Material</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('backsite.dashboard.index') }}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Test Material</a></li>
                                <li class="breadcrumb-item active">Edit</li>
                                <li class="breadcrumb-item"><a
                                        href="{{ route('backsite.material_testing.proses', encrypt($test_material->material_testing_id)) }}">kembali</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.test_material.update', [$test_material->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <select name="check_material_id" id="check_material_id"
                                                            ...
                                                            @foreach ($check_material as $key => $check_material_item)
                                                                <option value="{{ $check_material_item->id }}"
                                                                    {{ $check_material_item->id == $test_material->check_material_id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-4">
                                                        @foreach ($check_material as $key => $check_material_item)
                                                            @if ($check_material_item->id == $test_material->check_material_id)
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="jumlah" name="jumlah"
                                                            class="form-control"
                                                            value="{{ old('jumlah', isset($test_material) ? $test_material->jumlah : '') }}"
                                                        ...
                                                        <select name="satuan_id" id="satuan" class="form-control select2"
                                                            ...
                                                            @foreach ($satuan as $key => $satuan_item)
                                                                <option value="{{ $satuan_item->id }}"
                                                                    {{ $satuan_item->id == $test_material->satuan_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="hasil" id="hasil"
                                                            ...
                                                            <option value="1"
                                                                {{ $test_material->hasil == 1 ? 'selected' : '' }}>Sesuai
                                                            </option>
                                                            <option value="2"
                                                                {{ $test_material->hasil == 2 ? 'selected' : '' }}>Tidak
                                                                Sesuai</option>
                                                        </select>
                                                ...
                                                <div class="form-actions text-right">
                                                    <a href="{{ route('backsite.material_testing.proses', encrypt($test_material->material_testing_id)) }}"
