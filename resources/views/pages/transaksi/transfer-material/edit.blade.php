...
{{-- set title --}}
@section('title', 'Edit - Pembuatan Sampel/Pendaftaran Lab')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Pembuatan Sampel/Pendaftaran Lab</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('backsite.dashboard.index') }}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Pembuatan Sampel/Pendaftaran Lab</a></li>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.transfer_material.update', [$transfer_material->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="tgl_penyerahan" name="tgl_penyerahan"
                                                            class="form-control"
                                                            value="{{ old('tgl_penyerahan', isset($transfer_material) ? $transfer_material->tgl_penyerahan : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="lokasi" name="lokasi"
                                                            class="form-control"
                                                            value="{{ old('lokasi', isset($transfer_material) ? $transfer_material->lokasi : '') }}"
                                                            autocomplete="off">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="status" id="status"
                                                            ...
                                                            <option value="1"
                                                                {{ $transfer_material->status == 1 ? 'selected' : '' }}>
                                                                Sesuai</option>
                                                            <option value="2"
                                                                {{ $transfer_material->status == 2 ? 'selected' : '' }}>
                                                                Tidak Sesuai</option>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-2 label-control" for="kak">File
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea rows="5" class="form-control summernote" id="keterangan" name="keterangan">{{ isset($transfer_material) ? $transfer_material->keterangan : '' }}</textarea>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.material_submission.penyerahan', encrypt($transfer_material->material_submission_id)) }}"
