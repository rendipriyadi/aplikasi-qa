        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Kontraktor</h3>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.vendor.update', [$vendor->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="name">Nama Kontraktor
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.vendor.index') }}" style="width:120px;"
